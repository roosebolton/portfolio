...
- Echter: de json die uiteindelijk die uit de fetch response wordt opgelever, wordt later niet eens gebruikt.
- Het is duidelijk dat er 5 cellen moeten worden gevuld. Daarvoor moet er vijf keer een tabelcell worden aangemaak. Dat gebeurt nu in de methode zelf
- De json uit de fet
